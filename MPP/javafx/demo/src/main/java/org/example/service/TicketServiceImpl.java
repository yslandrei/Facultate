...
public class TicketServiceImpl implements TicketService, Observable {
    ...
    public TicketServiceImpl(ConcertRepository concertRepository, TicketRepository ticketRepository) {
