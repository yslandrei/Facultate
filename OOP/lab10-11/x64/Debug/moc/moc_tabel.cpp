...
Q_CONSTINIT static const qt_meta_stringdata_CLASSMyTableModelENDCLASS_t qt_meta_stringdata_CLASSMyTableModelENDCLASS = {
    {
        ...
        QT_MOC_LITERAL(13, 12),  // "countChanged"
        QT_MOC_LITERAL(26, 0),  // ""
        QT_MOC_LITERAL(27, 5)   // "count"
    },
    "MyTableModel",
    "countChanged",
    "",
...
void MyTableModel::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (MyTableModel::*)();
            if (_t _q_method = &MyTableModel::countChanged; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void MyTableModel::countChanged()
{
