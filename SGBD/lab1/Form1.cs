...
namespace lab1
    ...
    public partial class Form1 : Form
    {
        ...
        private void buttonAdd_Click(object sender, EventArgs e)
        {
            ...
            da.InsertCommand.Parameters.Add("@p", SqlDbType.Money).Value = textBoxPrice.Text;
            cs.Open();
        ...
        private void buttonUpdate_Click(object sender, EventArgs e)
        {
            ...
            da.UpdateCommand.Parameters.Add("@p", SqlDbType.Money).Value = textBoxPrice.Text;
            da.UpdateCommand.Parameters.Add("@id", SqlDbType.Int).Value = dsChild.Tables[0].Rows[bsChild.Position][0];
            cs.Open();
